...
namespace DesktopColorPicker
{
    ...
    public partial class MagnifyingGlass : UserControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (ShowPixel)
            {
                int xy = PixelSize * PixelRange;                                                      // -3 stammt von Enders: sonst wird das Pixel an falscher Position angezeigt
                e.Graphics.DrawRectangle(new Pen(new SolidBrush(Color.Black)), new Rectangle(new Point(xy-3, xy-3), new Size(PixelSize+1, PixelSize+1)));
                e.Graphics.DrawRectangle(new Pen(new SolidBrush(Color.White)), new Rectangle(new Point(xy-2, xy-2), new Size(PixelSize-1, PixelSize-1)));
            }
...
//                MovingGlass.Show();
    ...
    public class MovingMagnifyingGlass : Form
    {
        ...
        public MovingMagnifyingGlass()
        {
            ...
            MagnifyingGlass.UpdateTimer.Interval = 200;
